...
Original file is located at
    https://colab.research.google.com/drive/1wjqXh7IYf2pPHvNQYDw9dRUxH9qqeD8T
...
if(i==10): #pengecekan nilai i apakah dengan 10
...
while j<6:
	#lakukan printah ini ketika 		 perulangan 
...
for i in range (1,6): #perulangan for sebagi inisialisasi dari angka 1 hingga angka yang lebih kecil daripada 6.
